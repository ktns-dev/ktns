        ...
        <div className="px-5 pt-5 pb-4 border-b border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="text-base font-bold text-slate-800 dark:text-slate-100">Expense Categories</h2>
            </div>
          </div>
            ...
            table.getRowModel().rows.map((row) => (
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-xs text-slate-400 font-medium tracking-wide">#{row.original.expense_cat_name_id}</p>
                    <p className="text-sm font-bold text-slate-800 dark:text-slate-100 mt-0.5">
                      {row.original.expense_cat_name}
                    </p>
                  </div>
                  <DelConfirmMsg
                    rowId={row.original.expense_cat_name_id}
